...
import { cancelDeleteBooking } from "../../_actions/cancel-delete-booking"
...
export function BookingItem({ booking, showClientName }: BookingItemProps) {
  ...
  async function handleCancelBooking() {
    try {
      await cancelDeleteBooking(booking.id)
  ...
  function handleOpenSheet(isOpen: boolean) {
        ...
        <div className="mt-6">
          ...
          <div className="mb-6 mt-6">
            <BookingSumary
              ...
              selectedBarber={booking.barberName || undefined}
            />
          </div>
